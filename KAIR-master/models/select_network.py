...
def define_G(opt):
    ...
    # ----------------------------------------
        ...
        netG = net(upscale=opt_net['upscale'],
                   ...
                   rs_module=opt_net.get('rs_module', False),
                   rs_module_scale=opt_net.get('rs_module_scale', 0.1),
                   rs_module_hidden=opt_net.get('rs_module_hidden', 16))
    ...
    if opt['is_train']:
        init_weights(netG,
                     init_type=opt_net.get('init_type', 'default'),
                     init_bn_type=opt_net.get('init_bn_type', 'uniform'),
                     gain=opt_net.get('init_gain', 1))
